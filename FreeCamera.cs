...
public class FreeCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetAxis("Mouse ScrollWheel") != 0)
        {
            ...
            //for the scroll wheel to zoom on the camera, not the object
            GetComponent<Camera>().transform.localPosition = this.gameObject.transform.position + this.gameObject.transform.forward * m_distance;
        }
